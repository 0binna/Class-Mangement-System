...
def update_student_grade(student_id):
    try:
        ...
        grade = Grade.query.filter(
            Grade.course_id == course.id, Grade.student_id == student_id).one()
...
def retrieve_instructor_details(instructor_id):
    try:
...
def search_instructors():
    try:
        ...
        instructor_details = [instructor.short() for instructor in selection]
...
# Error handlers for all expected error
# ----------------------------------------------------------------------
